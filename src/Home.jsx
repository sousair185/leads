      ...
      <ul>
        {contacts.map((contact) => (
          <li key={contact.id}>
            ...
            <p>Realizar contato em: {contact.contactDate && format(parseISO(contact.contactDate), 'dd/MM/yyyy', { locale: ptBR })}</p>
            {contact.updatedAt && <p>Data de atualização: {contact.updatedAt}</p>}
